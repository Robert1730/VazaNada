...
CONSTRAINT fkLoginCadastro FOREIGN KEY (fkCadastro)
...
SELECT c.idCadastro, c.email, c.senha, l.senha AS login_senha, l.email AS login_email, l.idLogin, l.fkCadastro 
	FROM Login AS l 
		JOIN Cadastro AS c 
			ON l.fkCadastro = c.idCadastro;
